...
activities = {
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["marcus@mergington.edu", "amelia@mergington.edu"]
    },
    "Science Club": {
        "description": "Explore science experiments and discoveries",
        "schedule": "Wednesdays, 3:30 PM - 4:45 PM",
        "max_participants": 20,
        "participants": ["aisha@mergington.edu", "brian@mergington.edu"]
    }
}
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Validate student is not already signed up and the activity is not full
